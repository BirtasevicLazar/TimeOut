...
const PartyCategoriesManager = () => {
  ...
  const handleCreateCategory = async (name, image) => {
    ...
    if (result.success) {
      setSuccess('Kategorija za žurke je uspešno kreirana!')
  ...
  const handleUpdateCategory = async (name, image) => {
    ...
    const result = await updateCategory(selectedCategory.id, name, image, true) // is_party = true
    
    if (result.success) {
      setSuccess('Kategorija za žurke je uspešno ažurirana!')
  ...
  const handleDeleteCategory = async () => {
    ...
    if (result.success) {
      setSuccess('Kategorija za žurke je uspešno obrisana!')
  ...
  return (
    <div className="min-h-screen bg-gray-50">
        ...
        <div className="flex flex-col space-y-4">
          ...
          <div className="flex items-center justify-between">
            <div className="flex-1">
              ...
              <p className="text-sm text-gray-600">Upravljajte kategorijama pića za žurke</p>
            </div>
            <button
        ...
        {loading ? (
          <div className="flex justify-center items-center py-20">
            <div className="text-center">
              ...
              <p className="text-gray-600 font-medium">Učitavanje kategorija za žurke...</p>
            </div>
          </div>
        ) : categories.length === 0 ? (
          <div className="text-center py-20">
            ...
            <h3 className="text-xl font-semibold text-gray-900 mb-2">Nema kategorija za žurke</h3>
            <p className="text-gray-500 mb-8 max-w-sm mx-auto">Dodajte prvu kategoriju za žurke da biste počeli organizovanje pića</p>
            <button
              onClick={() => setShowAddModal(true)}
            ...
            >
              ...
              <span>Dodaj prvu kategoriju za žurke</span>
            </button>
          </div>
        ) : (
      ...
      <Modal
        ...
        onClose={closeAllModals}
        title="Edituj kategoriju za žurke"
      >
        <CategoryForm
      ...
      >
        <div className="space-y-4">
          <p className="text-gray-600">
            Da li ste sigurni da želite da obrišete kategoriju za žurke "{selectedCategory?.name}"?
          </p>
          ...
          {categoryDrinksCount > 0 ? (
            <div className="bg-red-50 border border-red-200 rounded-lg p-4">
              <div className="flex items-start space-x-3">
                ...
                <div className="flex-1">
                  <h3 className="text-sm font-medium text-red-800">Ne možete obrisati kategoriju za žurke!</h3>
              ...
              <div className="flex items-start space-x-3">
                ...
                <div className="flex-1">
                  <p className="text-sm text-green-700 font-medium">
                    Ova kategorija za žurke ne sadrži pića i može se bezbedno obrisati.
                  </p>
                </div>
              </div>
            </div>
